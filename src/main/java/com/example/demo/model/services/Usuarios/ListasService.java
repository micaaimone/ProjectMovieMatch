...
public class ListasService {
    ...
    public ListasService(
            ListasContenidoRepository listasContenidoRepository,
            ContenidoRepository contenidoRepository,
            UsuarioRepository usuarioRepository,
            ListasMapper listasMapper,
            RoleRepository roleRepository,
            @Lazy ContenidoLikeService contenidoLikeService
    ) {
        ...
        this.contenidoLikeService = contenidoLikeService; // <-- asignación
    }
    ...
    public void agregarContenido(Long idLista, String nombre) {
        ...
        if (!lista.getContenidos().contains(contenido)) {
            ...
            contenidoLikeService.darLike(lista.getUsuario().getId(), contenido.getId_contenido());
        } else {
    ...
    public void eliminarContenido(Long idLista, String nombre) {
        ...
        if (!removed) throw new ContenidoNotFound(nombre);
        listasContenidoRepository.save(lista);
    }
    ...
    public void cambiarNombre(Long idUser, String nombre, String newnombre) {
        if (newnombre != null) {
            ...
            listasContenidoRepository.save(lista);
        } else throw new IllegalArgumentException("nombre invalido");
    }
